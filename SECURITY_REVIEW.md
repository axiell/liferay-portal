...
2. Add HAProxy belt-and-suspenders rules: a path-traversal regex deny (`\.\./`, `%2e%2e`) — also closing the CVE-2018-1272 gap left by the `/WEB-INF`-only block — and denies for the Script Console and DDM template-editor portlet ids (verify ids against the live deployment first).
