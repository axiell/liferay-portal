...
version=7.0.4b
lexicon_version=1.0.24a
repo_url=http://jenkins.axiell.local:8081
repo_dir=~/.m2/repository
bundles_dir=/opt/java/liferay/arena-7.0.4-ga5/bundles.org
...
pushd ${bundles_dir}
zip -rX ${repo_dir}/com/liferay/portal/${file}/${version}/${file}-${version}.${packaging} osgi -x osgi/war/porygon-theme.war osgi/war/westeros-bank-theme.war osgi/war/fjord-theme.war osgi/war/1975-london-theme.war
popd
